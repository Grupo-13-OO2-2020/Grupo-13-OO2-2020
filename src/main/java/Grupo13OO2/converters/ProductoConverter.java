...
public class ProductoConverter {
	...
	public ProductoModel entityToModel(Producto producto) {
		return new ProductoModel(producto.getId(), producto.getDescripcion(), producto.getPrecioUnitario(),
				producto.getCodigoProducto(), producto.getTalle());
	}

	public Producto modelToEntity(ProductoModel modelo) {
		return new Producto(modelo.getId(), modelo.getDescripcion(), modelo.getPrecioUnitario(),
				modelo.getCodigoProducto(), modelo.getTalle());
	}
}
