...
public class ViewRouteHelper {
	...
	public final static String LOCAL_CALC_COORD = "local/ccoordenada-new";
	...
	// INDEX
	public final static String LOTE_INDEX = "lote/item-list";// aca esta la lista
