...
insert into local ( id,direccion, latitud, longitud, numero_telefono) values (5,"Mentruyt",-49.4505, 153.2949,22223333);
insert into local ( id,direccion, latitud, longitud, numero_telefono) values (6,"Ezeiza",-34.8478700,-58.5286900,66667777);
insert into local ( id,direccion, latitud, longitud, numero_telefono) values (7,"Adrogue",-34.7849,-58.3791,77778888);
