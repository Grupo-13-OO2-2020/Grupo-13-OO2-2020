...
insert into producto(id,descripcion,precio_unitario,codigo_producto,talle) values (2,"Pantalon",400,7792,38);
insert into producto(id,descripcion,precio_unitario,codigo_producto,talle) values (3,"Zapatilla",600,7793,42);
insert into producto(id,descripcion,precio_unitario,codigo_producto,talle) values (4,"Ojotas",150,7794,40);
 ...
 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (2,100,100,'2020-05-01',124,1,2);
 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (3,25,25,'2020-04-01',125,1,3);
 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (4,50,50,'2020-03-01',126,1,4);

 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (5,10,10,'2020-06-01',127,2,1);
 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (6,100,100,'2020-05-01',128,2,2);
 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (7,25,25,'2020-04-01',129,2,3);
 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (8,20,20,'2020-03-01',130,2,4);

 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (9,70,70,'2020-06-01',131,3,1);
 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (10,30,30,'2020-05-01',132,3,2);
 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (11,25,25,'2020-04-01',133,3,3);
 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (12,10,10,'2020-03-01',134,3,4);

 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (13,10,10,'2020-06-01',135,4,1);
 insert into lote(id,cantidad_existente, cantidad_recibida, fecha_ingreso, numero_de_lote, local_id, producto_id) values (14,5,5,'2020-05-01',136,4,2);
 ...
 insert into remito(id,forma_de_pago) values (4,"Credito");
  ...
  insert into pedido(id,cantidad,facturado,fecha,cliente_id,producto_id,vendedor_id) values (5,10,0,'2020-05-15',6,3,1);
  insert into solicitud_stock(aceptado,id,colaborador_id,local_id) values (0,5,null,2);
  insert into pedido(id,cantidad,facturado,fecha,cliente_id,producto_id,vendedor_id) values (6,5,0,'2020-05-15',6,4,2);
  insert into solicitud_stock(aceptado,id,local_id) values (0,6,1);

  insert into pedido(id,cantidad,facturado,fecha,cliente_id,producto_id,vendedor_id) values (7,15,0,'2020-05-25',6,4,3);
  insert into solicitud_stock(aceptado,id,local_id) values (0,7,4);
  insert into pedido(id,cantidad,facturado,fecha,cliente_id,producto_id,vendedor_id) values (8,9,0,'2020-05-07',8,1,4);
